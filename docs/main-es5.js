...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(svc, logSvc) {
                    this.svc = svc;
                    this.logSvc = logSvc;
                ...
                LoginComponent.prototype.CheckLogin = function () {
                    var _this = this;
                    this.svc.data.subscribe(function (da) { _this.users = da; });
                    console.log("this is the form username", this.userName.value);
                    console.log(this.users);
                    var y = this.users.filter(function (user) { return user.username == _this.userName.value; });
                    console.log(y);
                    try {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            NaviComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UsersComponent = /** @class */ (function () {
                function UsersComponent(svc, logSvc) {
                    var _this = this;
                    this.svc = svc;
                    this.logSvc = logSvc;
                    this.svc.data.subscribe(function (d) { return _this.users = d.length; });
                    console.log(this.users);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AlbumFormComponent = /** @class */ (function () {
                function AlbumFormComponent(svc) {
                    this.svc = svc;
                ...
                AlbumFormComponent.prototype.addAlbum = function () {
                    var newAlbum = { userId: this.userId.value, id: this.id.value, title: this.title.value };
            ...
            AlbumFormComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PostFormComponent = /** @class */ (function () {
                function PostFormComponent(svc) {
                    this.svc = svc;
                ...
                PostFormComponent.prototype.addPost = function () {
                    var newPost = { userId: this.userId.value, id: this.id.value, title: this.title.value, body: this.body.value };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TheUsersFormsComponent = /** @class */ (function () {
                function TheUsersFormsComponent(svc) {
                    this.svc = svc;
                    this.id = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('');
                ...
                TheUsersFormsComponent.prototype.ngOnInit = function () {
                };
                TheUsersFormsComponent.prototype.addUser = function () {
                    var newUser = { id: this.id.value, name: this.name.value, username: this.username.value, email: this.email.value };
                    console.log('ainsid addUser');
                    console.log(this.svc.data);
                    this.svc.addNewItem(newUser);
                };
                return TheUsersFormsComponent;
            }());
            TheUsersFormsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ToDoFormComponent = /** @class */ (function () {
                function ToDoFormComponent(svc) {
                    this.svc = svc;
                    this.userId = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('');
                    this.title = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('');
                ...
                ToDoFormComponent.prototype.addToLocalS = function () {
                    var value = JSON.stringify(this.svc.api);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchPipe = /** @class */ (function () {
                ...
                SearchPipe.prototype.transform = function (arr, fieldName, value) {
                    console.log('filterField', fieldName, value);
                    if (arr && arr.length && arr.length > 0 && fieldName && value) {
                        return arr.filter(function (item) { return item[fieldName] == (value); });
                    }
                    return null;
                };
                return SearchPipe;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AlbumService = /** @class */ (function (_super) {
                ...
                function AlbumService(http) {
                    var _this = _super.call(this, http, "albums") || this;
                    _this.http = http;
                    return _this;
                }
                return AlbumService;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BaseService = /** @class */ (function () {
                function BaseService(http, api) {
                    ...
                    this.http.get(this.api).subscribe(function (arr) { return _this.dataSubject.next(arr); });
                }
                BaseService.prototype.addNewItem = function (item) {
                    var dynamicItems = localStorage[this.api] ?
                        JSON.parse(localStorage[this.api]) : [];
                    var apiItems = this.dataSubject.value;
            ...
            var TodosService = /** @class */ (function () {
                function TodosService(http) {
                    ...
                    this.http.get('https://jsonplaceholder.typicode.com/todos/')
                        .subscribe(function (data) { return _this.api = data; });
